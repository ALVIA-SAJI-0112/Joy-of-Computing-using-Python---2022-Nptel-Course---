# -*- coding: utf-8 -*-
"""
Created on Fri Apr 15 16:15:40 2022
...
width=5
height=4
array=np.zeros([height,width,3],dtype=np.uint) #dtype-datatype assigned here is unsigned int
...
area_pun=(count_pun/count_pun)*3287263
print(area_pun)
